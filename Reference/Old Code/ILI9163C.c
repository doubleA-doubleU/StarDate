...
// A1 is turned into SDI1 but is not used or connected to anything
...
void SPI1_init() {
    ...
    TRISBbits.TRISB15 = 0; // SS is B15
    LATBbits.LATB15 = 1; // SS starts high
