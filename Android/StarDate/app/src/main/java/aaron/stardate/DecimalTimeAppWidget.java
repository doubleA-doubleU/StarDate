...
public class DecimalTimeAppWidget extends AppWidgetProvider {
    ...
    public static void updateAppWidget(final Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
        ...
        String dectime = String.format(Locale.getDefault(),
                " %d:%02d:%02d ", dh, dm, ds);

        // Construct the RemoteViews object
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.decimaltime_app_widget);
        views.setTextViewText(R.id.decimaltime_widget_text, dectime);
