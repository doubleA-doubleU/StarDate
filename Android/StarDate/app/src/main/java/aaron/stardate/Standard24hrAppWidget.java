...
public class Standard24hrAppWidget extends AppWidgetProvider {
    ...
    public static void updateAppWidget(final Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
        ...
        String time24 = dateFormat.format(new Date());

        // Construct the RemoteViews object
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.standard24hr_app_widget);
        views.setTextViewText(R.id.std24_widget_text, time24);
